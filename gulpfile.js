...
gulp.task('signature', function () {
  return gulp.src('src/signature/**/*')
    .pipe(gulp.dest('dist/signature'))
})
...
gulp.task('requiredFiles', function () {
  return gulp.src([
      'src/mail.php',
      'src/response.php',
      'src/sitemap.xml',
...
gulp.task('build', function (callback) {
  runSequence(
    ...
    ['useref', 'images', 'fonts', 'phpmailer', 'signature', 'service', 'requiredFiles'],
    callback
  )
})
